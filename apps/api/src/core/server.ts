...
// Creates a dev server's bucket, and sets the rule that expires leftover tool images
await prepareBucket().catch(err => reportError("Couldn't prepare the storage bucket", err))
