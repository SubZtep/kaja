...
test("sessionsPage renders meta rows with links and delete forms", () => {
  ...
  expect(html).toContain('href="/sessions/01900000-0000-7000-8000-000000000007"')
  expect(html).toContain("Hello &lt;world&gt;")
  expect(html).toContain('action="/sessions/01900000-0000-7000-8000-000000000007/delete"')
