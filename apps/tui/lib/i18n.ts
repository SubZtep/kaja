// Static i18n: both dictionaries load at import, the active language is set once at startup (cli.ts, from preferences.locale). No live switching — a language change takes effect on the next launch.
