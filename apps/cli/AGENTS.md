...
locales/                # en.toml, hu.toml, zh-TW.toml
...
- User-facing strings go through `t()` from `lib/i18n.ts` with keys in **all three** of `locales/en.toml`, `locales/hu.toml`, and `locales/zh-TW.toml`
