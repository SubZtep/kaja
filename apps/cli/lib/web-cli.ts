import { isExists as configExists, getConfigPath, readConfigLoose } from "./config"
    ...
    routes: {
      ...
      "/personas": async () => {
        ...
        const [
          ...
          { datasetInfoTool }
        ] = await Promise.all([import("./agents"), import("../tools/memory"), import("../tools/dataset-info")])
        const previewTools = [
          askUserTool,
          runCommandTool,
          switchPersonaTool,
